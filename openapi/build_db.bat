...
call sqlacodegen.exe --option nobidi --option nojoined --schema lds  --outfile ../backend/database/models/lds.py mssql+pyodbc://sa:Onyks$us@owl.agatit.pl:1449/NefrytLDS_Zygmuntow_2022?driver=ODBC+Driver+17+for+SQL+Server
call sqlacodegen.exe --option nobidi --option nojoined --schema editor --outfile ../backend/database/models/editor.py mssql+pyodbc://sa:Onyks$us@owl.agatit.pl:1449/NefrytLDS_Zygmuntow_2022?driver=ODBC+Driver+17+for+SQL+Server
call sqlacodegen.exe --option nobidi --option nojoined --schema obj --outfile ../backend/database/models/obj.py mssql+pyodbc://sa:Onyks$us@owl.agatit.pl:1449/NefrytLDS_Zygmuntow_2022?driver=ODBC+Driver+17+for+SQL+Server
